...
/*
 * ----------------------------------------------------
 * Generated stub function for bplib_os_get_dtntime_ms()
 * ----------------------------------------------------
 */
...
/*
 * ----------------------------------------------------
 * Generated stub function for bplib_os_systime()
 * ----------------------------------------------------
 */
int bplib_os_systime(unsigned long *sysnow)
{
    UT_GenStub_SetupReturnBuffer(bplib_os_systime, int);

    UT_GenStub_AddParam(bplib_os_systime, unsigned long *, sysnow);

    UT_GenStub_Execute(bplib_os_systime, Basic, NULL);

    return UT_GenStub_GetReturnValue(bplib_os_systime, int);
}
...
int bplib_os_wait_until_ms(bp_handle_t h, uint64_t abs_dtntime_ms)
{
    ...
    UT_GenStub_AddParam(bplib_os_wait_until_ms, uint64_t, abs_dtntime_ms);
...
/*
 * ----------------------------------------------------
 * Generated stub function for bplib_os_waiton()
 * ----------------------------------------------------
 */
int bplib_os_waiton(bp_handle_t h, int timeout_ms)
{
    UT_GenStub_SetupReturnBuffer(bplib_os_waiton, int);

    UT_GenStub_AddParam(bplib_os_waiton, bp_handle_t, h);
    UT_GenStub_AddParam(bplib_os_waiton, int, timeout_ms);

    UT_GenStub_Execute(bplib_os_waiton, Basic, NULL);

    return UT_GenStub_GetReturnValue(bplib_os_waiton, int);
}

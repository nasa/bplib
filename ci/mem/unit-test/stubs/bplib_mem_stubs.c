...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_DebugPrintListStats, BPLib_STOR_MEM_Block_t *, list);
                                     ...
                                     BPLib_STOR_MEM_CallbackFunc_t callback_fn, void *callback_arg)
{
    ...
    UT_GenStub_AddParam(BPLib_STOR_MEM_ForeachItemInList, bool, always_remove);
    UT_GenStub_AddParam(BPLib_STOR_MEM_ForeachItemInList, BPLib_STOR_MEM_CallbackFunc_t, callback_fn);
...
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_MEM_GenericDataUncast, BPLib_STOR_MEM_Block_t *);

    UT_GenStub_AddParam(BPLib_STOR_MEM_GenericDataUncast, void *, blk);
    UT_GenStub_AddParam(BPLib_STOR_MEM_GenericDataUncast, BPLib_STOR_MEM_Blocktype_t, parent_bt);
...
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_MEM_GetBlockFromLink, BPLib_STOR_MEM_Block_t *);
...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_InitListHead, BPLib_STOR_MEM_Block_t *, base_block);
...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_InitSecondaryLink, BPLib_STOR_MEM_Block_t *, base_block);
    UT_GenStub_AddParam(BPLib_STOR_MEM_InitSecondaryLink, BPLib_STOR_MEM_Block_t *, secondary_link);
...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_InsertAfter, BPLib_STOR_MEM_Block_t *, list);
...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_InsertBefore, BPLib_STOR_MEM_Block_t *, list);
...
{
    UT_GenStub_AddParam(BPLib_STOR_MEM_MergeList, BPLib_STOR_MEM_Block_t *, dest);
...
BPLib_STOR_MEM_Block_t *BPLib_STOR_MEM_SearchList(const BPLib_STOR_MEM_Block_t *list, BPLib_STOR_MEM_CallbackFunc_t match_fn,
                                             void *match_arg)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_MEM_SearchList, BPLib_STOR_MEM_Block_t *);

    UT_GenStub_AddParam(BPLib_STOR_MEM_SearchList, const BPLib_STOR_MEM_Block_t *, list);

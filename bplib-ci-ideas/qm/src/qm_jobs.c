...
*/
BPLib_QM_JobState_t BPLib_Job_CLA_Ingress(BPLib_QM_QueueTable_t* tbl, BPLib_Bundle_t* bundle)
{
    printf("CLA TO BI\n");
    sleep(1);
...
BPLib_QM_JobState_t BPLib_Job_CACHE(BPLib_QM_QueueTable_t* tbl, BPLib_Bundle_t* bundle)
{
    printf("CACHE TO CT\n");
    sleep(1);
...
void BPLib_QM_JobTableInit()
{
    ...
    job_funcs[STATE_CLA_TO_BI] = BPLib_Job_CLA_Ingress;
    job_funcs[STATE_BI_TO_EBP] = BPLib_Job_BI_Ingress;
    job_funcs[STATE_EBP_TO_CT] = BPLib_Job_EBP_Ingress;
    job_funcs[STATE_CT_TO_CACHE] = BPLib_Job_CT_Ingress;
    job_funcs[STATE_CACHE_TO_CT] = BPLib_Job_CACHE;

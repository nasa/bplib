...
#ifndef _BPLIB_CRC16_H_
#define _BPLIB_CRC16_H_
...
crc_return get_crc16(uint8_t* data, int length, struct crc_parameters* params);
// Checks that a crc parameters properly computes its check value.
bool validate_crc16_parameters(struct crc_parameters* params);
#endif /* _BPLIB_CRC16_H_ */

...
#define BPLIB_NC_ADD_APP_ERR_EID                        (550u)
#define BPLIB_NC_RM_APP_ERR_EID                         (551u)
#define BPLIB_NC_SET_REGI_STAT_ERR_EID                  (552u)
#define BPLIB_NC_START_APP_ERR_EID                      (553u)
#define BPLIB_NC_STOP_APP_ERR_EID                       (554u)
#define BPLIB_NC_ADD_AUTH_SRCS_ERR_EID                  (555u)
#define BPLIB_NC_RM_AUTH_SRCS_ERR_EID                   (556u)
#define BPLIB_NC_ADD_AUTH_CUST_SRCS_ERR_EID             (557u)
#define BPLIB_NC_RM_AUTH_CUST_SRCS_ERR_EID              (558u)
#define BPLIB_NC_ADD_AUTH_CUSTODIANS_ERR_EID            (559u)
#define BPLIB_NC_RM_AUTH_CUSTODIANS_ERR_EID             (560u)
#define BPLIB_NC_ADD_AUTH_RPT_EID_ERR_EID               (561u)
#define BPLIB_NC_RM_AUTH_RPT_EID_ERR_EID                (562u)
#define BPLIB_NC_ADD_LATENCY_ERR_EID                    (563u)
#define BPLIB_NC_RM_LATENCY_ERR_EID                     (564u)
#define BPLIB_NC_CONTACT_SETUP_ERR_EID                  (565u)
#define BPLIB_NC_CONTACT_START_ERR_EID                  (566u)
#define BPLIB_NC_CONTACT_STOP_ERR_EID                   (567u)
#define BPLIB_NC_CONTACT_TEARDOWN_ERR_EID               (568u)
#define BPLIB_NC_ADD_MIB_ARR_KEY_ERR_EID                (569u)
#define BPLIB_NC_RM_MIB_ARR_KEY_ERR_EID                 (570u)
#define BPLIB_NC_SET_MIB_ITEM_ERR_EID                   (571u)
#define BPLIB_NC_ADD_STOR_ALLOC_ERR_EID                 (572u)
#define BPLIB_NC_RM_STOR_ALLOC_ERR_EID                  (573u)
#define BPLIB_NC_PERFORM_SELF_TEST_ERR_EID              (574u)
...
/* AS error event IDs */
#define BPLIB_AS_SET_VALUE_BOUNDS_ERR_EID               (579u)
...
#define BPLIB_AS_RESET_SRC_INVAL_EID_ERR_EID            (587u)
#define BPLIB_AS_RESET_SRC_ERR_EID                      (588u)
#define BPLIB_AS_RESET_BNDL_INVAL_EID_ERR_EID           (589u)
#define BPLIB_AS_RESET_BNDL_ERR_EID                     (590u)
#define BPLIB_AS_RESET_ERR_INVAL_EID_ERR_EID            (591u)
#define BPLIB_AS_RESET_ERR_ERR_EID                      (592u)
#define BPLIB_AS_RESET_ALL_ERR_EID                      (593u)

...
#define BPLIB_AS_RESET_SRC_INVAL_EID_ERR_EID            (589u)
#define BPLIB_AS_RESET_SRC_UNKNOWN_SRC_CNTR_ERR_EID     (590u)
#define BPLIB_AS_RESET_BNDL_INVAL_EID_ERR_EID           (591u)
#define BPLIB_AS_RESET_BNDL_UNKNOWN_NODE_CNTR_ERR_EID   (592u)
#define BPLIB_AS_RESET_BNDL_UNKNOWN_SRC_CNTR_ERR_EID    (593u)
#define BPLIB_AS_RESET_ERR_UNKNOWN_NODE_CNTR_ERR_EID    (594u)

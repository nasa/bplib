...
#define BPLIB_ADU_ADD_CHAN_ERR_EID                  (102u)
#define BPLIB_ADU_ADD_STAT_ERR_EID                  (103u)
#define BPLIB_RM_APP_ERR_EID                        (104u)
#define BPLIB_SET_REGI_STAT_ERR_EID                 (105u)
#define BPLIB_START_APP_ERR_EID                     (106u)
#define BPLIB_ADU_TOO_BIG_ERR_EID                   (107u)
#define BPLIB_ADU_START_CHAN_ERR_EID                (108u)
#define BPLIB_ADU_START_STAT_ERR_EID                (109u)
#define BPLIB_ADU_START_SUB_ERR_EID                 (110u)
#define BPLIB_STOP_APP_ERR_EID                      (111u)
#define BPLIB_ADU_STOP_CHAN_ERR_EID                 (112u)
#define BPLIB_ADU_STOP_STAT_ERR_EID                 (113u)
#define BPLIB_ADU_UNSUB_ERR_EID                     (114u)
#define BPLIB_ADD_AUTH_SRCS_ERR_EID                 (115u)
#define BPLIB_RM_AUTH_SRCS_ERR_EID                  (116u)
#define BPLIB_RM_AUTH_CUST_SRCS_ERR_EID             (117u)
#define BPLIB_ADD_AUTH_CUSTODIANS_ERR_EID           (118u)
#define BPLIB_RM_AUTH_CUSTODIANS_ERR_EID            (119u)
#define BPLIB_ADD_AUTH_RPT_EID_ERR_EID              (120u)
#define BPLIB_RM_AUTH_RPT_EID_ERR_EID               (121u)
#define BPLIB_ADD_LATENCY_ERR_EID                   (122u)
#define BPLIB_RM_LATENCY_ERR_EID                    (123u)
#define BPLIB_CONTACT_SETUP_ERR_EID                 (124u)
#define BPLIB_CONTACT_START_ERR_EID                 (125u)
#define BPLIB_CONTACT_STOP_ERR_EID                  (126u)
#define BPLIB_CONTACT_TEARDOWN_ERR_EID              (127u)
#define BPLIB_ADD_MIB_ARR_KEY_ERR_EID               (128u)
#define BPLIB_RM_MIB_ARR_KEY_ERR_EID                (129u)
#define BPLIB_SET_MIB_ITEM_ERR_EID                  (130u)
#define BPLIB_ADD_STOR_ALLOC_ERR_EID                (131u)
#define BPLIB_RM_STOR_ALLOC_ERR_EID                 (132u)
#define BPLIB_PERFORM_SELF_TEST_ERR_EID             (133u)
#define BPLIB_SEND_NODE_MIB_CFG_ERR_EID             (134u)
#define BPLIB_SEND_SRC_MIB_CFG_ERR_EID              (135u)
#define BPLIB_SEND_NODE_MIB_CTRS_ERR_EID            (136u)
#define BPLIB_SEND_SRC_MIB_CTRS_ERR_EID             (137u)
#define BPLIB_SEND_STOR_ERR_EID                     (138u)
#define BPLIB_SEND_CHAN_CONTACT_STAT_ERR_EID        (139u)

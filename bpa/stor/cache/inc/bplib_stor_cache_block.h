 ...
 *
 * This is the inverse of BPLib_STOR_CACHE_GenericDataCast() and allows obtaining the pool
 * block from a generic data pointer.  The pointer passed in must be from a prior call
 * to BPLib_STOR_CACHE_GenericDataCast() or else the result is undefined.
 *
 * @param blk pointer from previous call to BPLib_STOR_CACHE_GenericDataCast
 * @param required_magic
 * @return BPLib_STOR_CACHE_GenericData_t*
 */

...
void test_BPLib_STOR_CACHE_FsmStateQueueEnter(void)
{
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctCast), UT_cache_sizet_Handler, NULL);
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPush), UT_cache_int8_Handler, NULL);

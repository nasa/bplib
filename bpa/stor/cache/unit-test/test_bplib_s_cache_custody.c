...
void test_bplib_cache_custody_check_dacs(void)
{
    ...
    memset(&state, 0, sizeof(bplib_cache_state_t));
    memset(&qblk, 0, sizeof(BPLib_MEM_block_t));
...
void test_bplib_cache_custody_store_bundle(void)
{
    ...
    memset(&state, 0, sizeof(bplib_cache_state_t));
    memset(&qblk, 0, sizeof(BPLib_MEM_block_t));
    memset(&qblk1, 0, sizeof(BPLib_MEM_block_t));
    memset(&pri_block, 0, sizeof(BPLib_STOR_CACHE_BblockPrimary_t));
    memset(&custody_rbt_link, 0, sizeof(bplib_rbt_link_t));
    memset(&store_entry, 0, sizeof(bplib_cache_entry_t));
...
{
    /* Test function for:
     * void bplib_cache_custody_insert_tracking_block(bplib_cache_state_t *state, BPLib_STOR_CACHE_BblockPrimary_t
...
{
    /* Test function for:
     * BPLib_MEM_ref_t bplib_cache_custody_create_dacs(bplib_cache_state_t *state, BPLib_STOR_CACHE_BblockPrimary_t
...
{
    /* Test function for:
     * void bplib_cache_custody_process_remote_dacs_bundle(bplib_cache_state_t *state, BPLib_STOR_CACHE_BblockPrimary_t

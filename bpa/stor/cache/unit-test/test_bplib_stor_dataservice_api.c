...
void test_BPLib_STOR_CACHE_DataserviceAddBaseIntf(void)
{
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctAlloc), UT_lib_AltHandler_PointerReturn, NULL);
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctAlloc), UT_lib_AltHandler_PointerReturn, &sblk);
    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_DataserviceAddBaseIntf(&rtbl, node_number).hdl, 0);
...
void test_BPLib_STOR_CACHE_DataserviceAttach(void)
{
   ...
   BPLib_STOR_CACHE_DataserviceType_t    type = BPLib_STOR_CACHE_DataserviceTypeStorage;
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctCast), UT_lib_AltHandler_PointerReturn, NULL);
    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_DataserviceAttach(&rtbl, &ipn, type, &blkref).hdl, 0);

    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctCast), UT_lib_AltHandler_PointerReturn, &sblk);
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctModifyFlags), UT_lib_sizet_Handler, NULL);
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctModifyFlags), UT_lib_int8_Handler, NULL);
...
void test_bplib_send(void)
{
   ...
   BPLib_STOR_CACHE_SocketInfo_t            sock;
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctCast), UT_lib_AltHandler_PointerReturn, &duct);
    UtAssert_UINT32_NEQ(bplib_send(&desc, payload, size, timeout), 0);
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPush), UT_lib_int8_Handler, NULL);
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPush), UT_lib_bool_Handler, NULL);
...
void test_bplib_recv(void)
{
   ...
   BPLib_STOR_CACHE_SocketInfo_t            sock;
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPull), UT_lib_AltHandler_PointerReturn, &blk);
    UtAssert_UINT32_NEQ(bplib_recv(&desc, payload, &size, timeout), 0);
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_GenericDataCast), UT_lib_AltHandler_PointerReturn, NULL);
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctCast), UT_lib_AltHandler_PointerReturn, NULL);
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPull), UT_lib_AltHandler_PointerReturn, NULL);
...
void test_BPLib_STOR_CACHE_ServiceductForwardIngress(void)
{
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPull), UT_lib_ingress_AltHandler_PointerReturn, &sblk);
    UtAssert_UINT32_NEQ(BPLib_STOR_CACHE_ServiceductForwardIngress(&tbl, &subq_src), 0);
...
void test_BPLib_STOR_CACHE_ServiceductForwardEgress(void)
{
    ...
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_DuctTryPull), UT_lib_egress_AltHandler_PointerReturn, &sblk);
...
void test_BPLib_STOR_CACHE_DataserviceEventImpl(void)
{
    ...
    memset(&event, 0, sizeof(BPLib_STOR_CACHE_DuctGenericEvent_t));
    ...
    event.event_type = BPLib_STOR_CACHE_DuctEventUp;
    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_DataserviceEventImpl(&event, &intf_block), 0);
    ...
    event.event_type = BPLib_STOR_CACHE_DuctEventDown;
    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_DataserviceEventImpl(&event, &intf_block), 0);

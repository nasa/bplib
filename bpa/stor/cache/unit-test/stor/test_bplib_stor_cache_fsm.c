...
void test_BPLib_STOR_CACHE_Module_fsm_state_idle_eval(void)
{
    /* Test function for:
    ...
    memset(&parent, 0, sizeof(BPLib_STOR_CACHE_Module_state_t));
    ...
    offload_api.restore = test_BPLib_STOR_CACHE_Module_restore_stub;
    parent.offload_api  = &offload_api;

    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_Module_fsm_state_idle_eval(&store_entry), 0);

    store_entry.expire_time = 10;
    store_entry.flags       = 0;
    UtAssert_UINT32_GT(BPLib_STOR_CACHE_Module_fsm_state_idle_eval(&store_entry), 0);
...
void test_BPLib_STOR_CACHE_Module_fsm_state_queue_eval(void)
{
    /* Test function for:
    ...
    UtAssert_UINT32_GT(BPLib_STOR_CACHE_Module_fsm_state_queue_eval(&store_entry), 0);

    store_entry.flags = 8;
    UtAssert_UINT32_GT(BPLib_STOR_CACHE_Module_fsm_state_queue_eval(&store_entry), 0);
}

void test_BPLib_STOR_CACHE_Module_fsm_state_queue_enter(void)
{
    /* Test function for:
    ...
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_state_queue_enter(&store_entry));

    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_RefMakeBlock), UT_cache_AltHandler_PointerReturn, NULL);
}

void test_BPLib_STOR_CACHE_Module_fsm_execute(void)
{
    /* Test function for:
    ...
    store_entry.state  = BPLib_STOR_CACHE_Module_entry_state_idle;

    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_GenericDataCast), UT_cache_AltHandler_PointerReturn, &store_entry);
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_execute(&sblk));

    store_entry.expire_time = 1;
    UT_SetHandlerFunction(UT_KEY(BPLib_STOR_CACHE_RBT_GetKeyValue), UT_cache_sizet_Handler, NULL);
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_execute(&sblk));
...
void test_BPLib_STOR_CACHE_Module_fsm_state_queue_exit(void)
{
    /* Test function for:
    ...
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_state_queue_exit(&store_entry));
...
void test_BPLib_STOR_CACHE_Module_fsm_state_delete_eval(void)
{
    /* Test function for:
    ...
    UtAssert_NULL(BPLib_STOR_CACHE_Module_fsm_state_delete_eval(&store_entry));

    store_entry.flags  = 1;
    store_entry.parent = &state;
    UtAssert_NOT_NULL(BPLib_STOR_CACHE_Module_fsm_state_delete_eval(&store_entry));
}

void test_BPLib_STOR_CACHE_Module_fsm_state_delete_enter(void)
{
    /* Test function for:
    ...
    memset(&refptr, 0, sizeof(BPLib_STOR_CACHE_Block_t));
    memset(&offload_api, 0, sizeof(BPLib_STOR_CACHE_Module_offload_api_t));
    offload_api.release             = test_BPLib_STOR_CACHE_Module_release_stub;
    store_entry.parent              = &state;
    store_entry.refptr              = (BPLib_STOR_CACHE_Ref_t)&refptr;
    store_entry.offload_sid         = 1;
    store_entry.parent->offload_api = &offload_api;

    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_state_delete_enter(&store_entry));
}

void test_BPLib_STOR_CACHE_Module_fsm_reschedule(void)
{
    /* Test function for:
    ...
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_reschedule(&state, &store_entry));

    store_entry.flags = 4;
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_reschedule(&state, &store_entry));
}

void test_BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_eval(void)
{
    /* Test function for:
    ...
    UtAssert_NOT_NULL(BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_eval(&store_entry));

    store_entry.flags = 4;
    UtAssert_NOT_NULL(BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_eval(&store_entry));
}

void test_BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_exit(void)
{
    /* Test function for:
    ...
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_exit(&store_entry));
}

void test_BPLib_STOR_CACHE_Module_fsm_transition_state(void)
{
    /* Test function for:
     ...
     */
    BPLib_STOR_CACHE_Module_entry_t entry;

    memset(&entry, 0, sizeof(BPLib_STOR_CACHE_Module_entry_t));
    entry.state                          = 10;
    BPLib_STOR_CACHE_Module_entry_state_t next_state = 10;

    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_transition_state(&entry, next_state));

    entry.state = BPLib_STOR_CACHE_Module_entry_state_generate_dacs;
    UtAssert_VOIDCALL(BPLib_STOR_CACHE_Module_fsm_transition_state(&entry, next_state));
}

void test_BPLib_STOR_CACHE_Module_fsm_get_next_state(void)
{
    /* Test function for:
    ...
    UtAssert_UINT32_EQ(BPLib_STOR_CACHE_Module_fsm_get_next_state(&entry), 0);
}

void TestBplibCacheFsm_Register(void)
{
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_idle_eval, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_idle_eval");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_queue_eval, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_queue_eval");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_queue_enter, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_queue_enter");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_execute, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_execute");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_queue_exit, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_queue_exit");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_delete_eval, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_delete_eval");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_delete_enter, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_state_delete_enter");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_reschedule, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_reschedule");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_eval, NULL, NULL,
               "Test BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_eval");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_exit, NULL, NULL,
               "Test BPLib_STOR_CACHE_Module_fsm_state_generate_dacs_exit");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_transition_state, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_transition_state");
    UtTest_Add(test_BPLib_STOR_CACHE_Module_fsm_get_next_state, NULL, NULL, "Test BPLib_STOR_CACHE_Module_fsm_get_next_state");
}

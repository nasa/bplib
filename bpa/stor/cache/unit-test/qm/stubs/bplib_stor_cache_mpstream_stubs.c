 ...
 * @file
 *
 * Auto-Generated stub implementations for functions defined in bplib_stor_cache_mpstream header
 */
 ...
 * ----------------------------------------------------
 */
void BPLib_STOR_CACHE_StartStreamInit(BPLib_STOR_CACHE_Stream_t *mps, BPLib_STOR_CACHE_Pool_t *pool,
                                      BPLib_STOR_CACHE_StreamDir_t dir)
{
    UT_GenStub_AddParam(BPLib_STOR_CACHE_StartStreamInit, BPLib_STOR_CACHE_Stream_t *, mps);
    UT_GenStub_AddParam(BPLib_STOR_CACHE_StartStreamInit, BPLib_STOR_CACHE_Pool_t *, pool);

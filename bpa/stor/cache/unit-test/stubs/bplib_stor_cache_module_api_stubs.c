                                      ...
                                      BPLib_STOR_CACHE_ModuleValtype_t vt, const void *val)
{
    ...
    UT_GenStub_AddParam(BPLib_STOR_CACHE_Configure, BPLib_STOR_CACHE_Block_t *, svc);
    UT_GenStub_AddParam(BPLib_STOR_CACHE_Configure, bp_handle_t, cache_intf_id);
...
/*
 * ----------------------------------------------------
 * Generated stub function for BPLib_STOR_CACHE_Instantiate()
 * ----------------------------------------------------
 */
static BPLib_STOR_CACHE_Block_t *BPLib_STOR_CACHE_Instantiate(BPLib_STOR_CACHE_Ref_t parent, void *init_arg)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_Instantiate, BPLib_STOR_CACHE_Block_t *);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_Instantiate, BPLib_STOR_CACHE_Ref_t, parent);
    UT_GenStub_AddParam(BPLib_STOR_CACHE_Instantiate, void *, init_arg);

    UT_GenStub_Execute(BPLib_STOR_CACHE_Instantiate, Basic, NULL);

    return UT_GenStub_GetReturnValue(BPLib_STOR_CACHE_Instantiate, BPLib_STOR_CACHE_Block_t *);
}

 ...
 * @file
 *
 * Auto-Generated stub implementations for functions defined in BPLib_STOR_CACHE_Module_mpool_flows header
 */
...
BPLib_STOR_CACHE_Block_t *BPLib_STOR_CACHE_FlowAlloc(BPLib_STOR_CACHE_Pool_t *pool, uint32_t magic_number, void *init_arg)
{
    ...
    UT_GenStub_AddParam(BPLib_STOR_CACHE_FlowAlloc, BPLib_STOR_CACHE_Pool_t *, pool);

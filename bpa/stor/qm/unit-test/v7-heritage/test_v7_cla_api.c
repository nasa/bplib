...
void test_BPLib_STOR_CACHE_CreateClaIntf(void)
{
    /* Test function for:
...
void test_BPLib_STOR_CACHE_ClaIngress(void)
{
    /* Test function for:
...
void test_BPLib_STOR_CACHE_ClaEgress(void)
{
    /* Test function for:
...
void test_BPLib_STOR_CACHE_ClaEventImpl(void)
{
    /* Test function for:
...
void test_BPLib_STOR_CACHE_GenericBundleIngress(void)
{
    /* Test function for:
    ...
    void                        *content    = NULL;
    size_t                       size       = 1;
    BPLib_TIME_MonotonicTime_t             time_limit = BPLIB_MONOTIME_ZERO;
    BPLib_STOR_QM_Duct_t           duct;
...
void test_BPLib_STOR_CACHE_GenericBundleEgress(void)
{
    /* Test function for:
...
{
    UtTest_Add(testBPLib_STOR_CACHE_CreateClaIntf, NULL, NULL, "Test_BPLib_STOR_CACHE_CreateClaIntf");
    UtTest_Add(testBPLib_STOR_CACHE_ClaIngress, NULL, NULL, "Test_BPLib_STOR_CACHE_ClaIngress");
    UtTest_Add(testBPLib_STOR_CACHE_ClaEgress, NULL, NULL, "Test_BPLib_STOR_CACHE_ClaEgress");
    UtTest_Add(testBPLib_STOR_CACHE_ClaEventImpl, NULL, NULL, "Test_BPLib_STOR_CACHE_ClaEventImpl");
    UtTest_Add(testBPLib_STOR_CACHE_GenericBundleIngress, NULL, NULL, "Test_BPLib_STOR_CACHE_GenericBundleIngress");
    UtTest_Add(testBPLib_STOR_CACHE_GenericBundleEgress, NULL, NULL, "Test_BPLib_STOR_CACHE_GenericBundleEgress");
}

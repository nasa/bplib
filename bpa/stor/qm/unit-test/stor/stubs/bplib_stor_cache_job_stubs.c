 ...
 * ----------------------------------------------------
 */
BPLib_STOR_CACHE_Job_t *BPLib_STOR_CACHE_JobGetNextActive(bplib_mpool_t *pool)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_JobGetNextActive, BPLib_STOR_CACHE_Job_t *);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_JobGetNextActive, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
void BPLib_STOR_CACHE_JobRunAll(bplib_mpool_t *pool, void *arg)
{
    UT_GenStub_AddParam(BPLib_STOR_CACHE_JobRunAll, bplib_mpool_t *, pool);

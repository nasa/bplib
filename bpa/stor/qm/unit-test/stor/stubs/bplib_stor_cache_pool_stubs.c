 ...
 * ----------------------------------------------------
 */
BPLib_STOR_CACHE_Block_t *BPLib_STOR_CACHE_BlockFromExternalId(bplib_mpool_t *pool, bp_handle_t handle)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_BlockFromExternalId, BPLib_STOR_CACHE_Block_t *);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_BlockFromExternalId, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
uint32_t BPLib_STOR_CACHE_CollectBlocks(bplib_mpool_t *pool, uint32_t limit)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_CollectBlocks, uint32_t);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_CollectBlocks, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
bplib_mpool_t *BPLib_STOR_CACHE_Create(void *pool_mem, size_t pool_size)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_Create, bplib_mpool_t *);
    ...
    return UT_GenStub_GetReturnValue(BPLib_STOR_CACHE_Create, bplib_mpool_t *);
}
 ...
 * ----------------------------------------------------
 */
void BPLib_STOR_CACHE_DebugScan(bplib_mpool_t *pool)
{
    UT_GenStub_AddParam(BPLib_STOR_CACHE_DebugScan, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
BPLib_STOR_CACHE_Block_t *BPLib_STOR_CACHE_GenericDataAlloc(bplib_mpool_t *pool, uint32_t magic_number, void *init_arg)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_GenericDataAlloc, BPLib_STOR_CACHE_Block_t *);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_GenericDataAlloc, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
bplib_mpool_t *BPLib_STOR_CACHE_GetParentPoolFromLink(BPLib_STOR_CACHE_Block_t *cb)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_GetParentPoolFromLink, bplib_mpool_t *);
    ...
    return UT_GenStub_GetReturnValue(BPLib_STOR_CACHE_GetParentPoolFromLink, bplib_mpool_t *);
}
 ...
 * ----------------------------------------------------
 */
void BPLib_STOR_CACHE_Maintain(bplib_mpool_t *pool)
{
    UT_GenStub_AddParam(BPLib_STOR_CACHE_Maintain, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
size_t BPLib_STOR_CACHE_QueryMemCurrentUse(bplib_mpool_t *pool)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_QueryMemCurrentUse, size_t);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_QueryMemCurrentUse, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
size_t BPLib_STOR_CACHE_QueryMemMaxUse(bplib_mpool_t *pool)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_QueryMemMaxUse, size_t);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_QueryMemMaxUse, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
void BPLib_STOR_CACHE_RecycleAllBlocksInList(bplib_mpool_t *pool, BPLib_STOR_CACHE_Block_t *list)
{
    UT_GenStub_AddParam(BPLib_STOR_CACHE_RecycleAllBlocksInList, bplib_mpool_t *, pool);
 ...
 * ----------------------------------------------------
 */
int BPLib_STOR_CACHE_RegisterBlocktype(bplib_mpool_t *pool, uint32_t magic_number, const BPLib_STOR_CACHE_BlocktypeApi_t *api,
                                   size_t user_content_size)
{
    UT_GenStub_SetupReturnBuffer(BPLib_STOR_CACHE_RegisterBlocktype, int);

    UT_GenStub_AddParam(BPLib_STOR_CACHE_RegisterBlocktype, bplib_mpool_t *, pool);

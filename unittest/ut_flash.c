...
static void test_1(void)
{
    ...
    ut_assert(flash_free_allocate(&block) == BP_ERROR,
              "Incorrectly succeeded to allocate block when no blocks available\n");

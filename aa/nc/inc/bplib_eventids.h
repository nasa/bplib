...
#define BPLIB_NOOP_SUCCESS_EID                      (43u)
...
#define BPLIB_SEND_NODE_MIB_CFG_SUCCESS_EID         (82u)
#define BPLIB_SEND_SRC_MIB_CFG_SUCCESS_EID          (83u)
#define BPLIB_SEND_NODE_MIB_CTRS_SUCCESS_EID        (84u)
#define BPLIB_SEND_SRC_MIB_CTRS_SUCCESS_EID         (85u)
#define BPLIB_SEND_STOR_SUCCESS_EID                 (86u)
#define BPLIB_SEND_CHAN_CONTACT_STAT_SUCCESS_EID    (87u)

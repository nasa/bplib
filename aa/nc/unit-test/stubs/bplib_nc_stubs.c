...
{
    UT_GenStub_SetupReturnBuffer(BPLib_NC_GetAppState, BPLib_NC_ApplicationState_t);

    UT_GenStub_AddParam(BPLib_NC_GetAppState, uint8_t, ChanId);

    UT_GenStub_Execute(BPLib_NC_GetAppState, Basic, NULL);

    return UT_GenStub_GetReturnValue(BPLib_NC_GetAppState, BPLib_NC_ApplicationState_t);
}
...
{
    UT_GenStub_AddParam(BPLib_NC_SetAppState, uint8_t, ChanId);
...
{
    UT_GenStub_SetupReturnBuffer(BPLib_NC_TableUpdate, BPLib_Status_t);

    UT_GenStub_Execute(BPLib_NC_TableUpdate, Basic, NULL);

    return UT_GenStub_GetReturnValue(BPLib_NC_TableUpdate, BPLib_Status_t);
}

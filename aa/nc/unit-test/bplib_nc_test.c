...
void Test_BPLib_NC_AddAllApplications_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_ALL_APPS_SUCCESS_EID);
...
void Test_BPLib_NC_StartAllApplications_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_START_ALL_APPS_SUCCESS_EID);
...
void Test_BPLib_NC_VerifyBundleStorage_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_VERIF_BNDL_SUCCESS_EID);
...
void Test_BPLib_NC_VerifyBundleMetadata_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_VERIF_BNDL_META_SUCCESS_EID);
...
void Test_BPLib_NC_RebuildBundleMetadata_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_REBUILD_BNDL_META_SUCCESS_EID);
...
void Test_BPLib_NC_ClearVolatile_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_CLR_VOLATILE_SUCCESS_EID);
...
void Test_BPLib_NC_ReloadSavedData_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RELOAD_SVD_DATA_SUCCESS_EID);
...
void Test_BPLib_NC_ResetAllCounters_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RESET_ALL_CTRS_SUCCESS_EID);
...
void Test_BPLib_NC_ResetCounter_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RESET_CTR_SUCCESS_EID);
...
void Test_BPLib_NC_ResetSourceCounters_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RESET_SRC_CTRS_SUCCESS_EID);
...
void Test_BPLib_NC_ResetBundleCounters_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RESET_BNDL_CTRS_SUCCESS_EID);
...
void Test_BPLib_NC_ResetErrorCounters_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RESET_ERR_CTRS_SUCCESS_EID);
...
void Test_BPLib_NC_AddApplication_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_APP_SUCCESS_EID);
...
void Test_BPLib_NC_SetRegistrationState_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SET_REGI_STAT_SUCCESS_EID);
...
void Test_BPLib_NC_StartApplication_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_START_APP_SUCCESS_EID);
...
void Test_BPLib_NC_StopApplication_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_STOP_APP_SUCCESS_EID);
...
void Test_BPLib_NC_AddAuthSources_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_AUTH_SRCS_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveAuthSources_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_AUTH_SRCS_SUCCESS_EID);
...
void Test_BPLib_NC_AddAuthCustodySources_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_AUTH_CUST_SRCS_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveAuthCustodySources_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_AUTH_CUST_SRCS_SUCCESS_EID);
...
void Test_BPLib_NC_AddAuthCustodians_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_AUTH_CUSTODIANS_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveAuthCustodians_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_AUTH_CUSTODIANS_SUCCESS_EID);
...
void Test_BPLib_NC_AddAuthReportToEid_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_AUTH_RPT_EID_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveAuthReportToEid_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_AUTH_RPT_EID_SUCCESS_EID);
...
void Test_BPLib_NC_AddLatency_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_LATENCY_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveLatency_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_LATENCY_SUCCESS_EID);
...
void Test_BPLib_NC_ContactSetup_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_CONTACT_SETUP_SUCCESS_EID);
...
void Test_BPLib_NC_ContactStart_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_CONTACT_START_SUCCESS_EID);
...
void Test_BPLib_NC_ContactStop_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_CONTACT_STOP_SUCCESS_EID);
...
void Test_BPLib_NC_ContactTeardown_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_CONTACT_TEARDOWN_SUCCESS_EID);
...
void Test_BPLib_NC_AddMibArrayKey_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_MIB_ARR_KEY_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveMibArrayKey_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_MIB_ARR_KEY_SUCCESS_EID);
...
void Test_BPLib_NC_SetMibItem_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SET_MIB_ITEM_SUCCESS_EID);
...
void Test_BPLib_NC_AddStorageAllocation_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_ADD_STOR_ALLOC_SUCCESS_EID);
...
void Test_BPLib_NC_RemoveStorageAllocation_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_RM_STOR_ALLOC_SUCCESS_EID);
...
void Test_BPLib_NC_PerformSelfTest_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_PERFORM_SELF_TEST_SUCCESS_EID);
...
void Test_BPLib_NC_SendNodeMibConfigHk_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SEND_NODE_MIB_CFG_HK_SUCCESS_EID);
...
void Test_BPLib_NC_SendSourceMibConfigHk_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SEND_SRC_MIB_CFG_HK_SUCCESS_EID);
...
void Test_BPLib_NC_SendSourceMibCountersHk_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SEND_SRC_MIB_CTRS_HK_SUCCESS_EID);
...
void Test_BPLib_NC_SendStorageHk_Nominal(void)
{
    ...
    UtAssert_INT32_EQ(context_BPLib_EM_SendEvent[0].EventID, BPLIB_SEND_STOR_HK_SUCCESS_EID);

...
void Test_BPLib_NC_AddAllApplications_Nominal(void)
{
    ...
    Test_BPLib_AS_VerifyIncrement(0, BUNDLE_AGENT_ACCEPTED_DIRECTIVE_COUNT, 1, 1);
...
void Test_BPLib_NC_AddAllApplications_Error(void)
{
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(0, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 1);
    */
}
...
void Test_BPLib_NC_ResetCounter_Nominal(void)
{
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(Payload.SourceEid, BUNDLE_AGENT_ACCEPTED_DIRECTIVE_COUNT, 1, 1);
...
void Test_BPLib_NC_ResetCounter_Error(void)
{
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(Payload.SourceEid, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 1);
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(Payload.SourceEid, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 2);
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(Payload.SourceEid, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 3);
...
void Test_BPLib_NC_SetMibItem_Error(void)
{
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(0, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 2);
    ...
    // Verify directive counter was incremented
    Test_BPLib_AS_VerifyIncrement(0, BUNDLE_AGENT_REJECTED_DIRECTIVE_COUNT, 1, 3);
    */
}

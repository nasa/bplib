...
BPLib_AS_Counter_t ResettableNodeCounters[BPLIB_AS_NUM_NODE_CNTRS] = {BUNDLE_AGT_ACCPT_CNT, BUNDLE_AGT_REJ_CNT,
                    BUNDLE_CNT_GEN_ACCPT, BUNDLE_CNT_GEN_REJ, BUNDLE_CNT_GEN_CUSTODY, BUNDLE_CNT_GEN_BSR_RECV,
                    BUNDLE_CNT_GEN_BSR_ACCPT, BUNDLE_CNT_GEN_BSR_FORW, BUNDLE_CNT_GEN_BSR_DELVR, BUNDLE_CNT_GEN_BSR_DEL,
                    BUNDLE_CNT_RECV_BSR_RECV, BUNDLE_CNT_RECV_BSR_ACCPT, BUNDLE_CNT_RECV_BSR_FORW,
                    BUNDLE_CNT_RECV_BSR_DELVR, BUNDLE_CNT_RECV_BSR_DEL, BUNDLE_CNT_MAX_BSR_RATE_EXCD, BUNDLE_CNT_GEN_CRS,
                    BUNDLE_CNT_GEN_CRS_RECV, BUNDLE_CNT_GEN_CRS_ACCPT, BUNDLE_CNT_GEN_CRS_FORW, BUNDLE_CNT_GEN_CRS_DELVR,
                    BUNDLE_CNT_GEN_CRS_DEL, BUNDLE_CNT_MAX_CRS_RATE_EXCD, BUNDLE_CNT_RECV_CRS, BUNDLE_CNT_RECV_CRS_RECV,
                    BUNDLE_CNT_RECV_CRS_ACCPT, BUNDLE_CNT_RECV_CRS_FORW, BUNDLE_CNT_RECV_CRS_DELVR,
                    BUNDLE_CNT_RECV_CRS_DEL, BUNDLE_CNT_GEN_FRAG, BUNDLE_CNT_RECV, BUNDLE_CNT_RECV_FRAG,
                    BUNDLE_CNT_UNPROC_BLKS, BUNDLE_CNT_INVAL_PRI_BLK, BUNDLE_CNT_CS_RECV, BUNDLE_CNT_FORW,
                    BUNDLE_CNT_FORW_FAILED, BUNDLE_CNT_FRAG, BUNDLE_CNT_REASSEMBLED, BUNDLE_CNT_FRAG_ERR,
                    BUNDLE_CNT_DELVR, BUNDLE_CNT_ABAND, ADU_CNT_DELVR, ADU_CNT_RECV, BUNDLE_CNT_DEL, BUNDLE_CNT_DEL_EXP,
                    BUNDLE_CNT_DEL_HOP_EXCD, BUNDLE_CNT_DEL_INVAL_PAY, BUNDLE_CNT_DEL_TRAF_PARED, BUNDLE_CNT_DEL_UNINTEL,
                    BUNDLE_CNT_DEL_UNSUPPORT_BLK, BUNDLE_CNT_DISCARDED, BUNDLE_CNT_DEL_NO_STOR, BUNDLE_CNT_DEL_BAD_EID,
                    BUNDLE_CNT_DEL_UNAUTH, BUNDLE_CNT_DEL_TOO_LONG, BUNDLE_CNT_CUSTODY_TRANS, BUNDLE_CNT_CUSTODY_REJ,
                    BUNDLE_CNT_CUSTODY_REQ, BUNDLE_CNT_CUSTODY_RE_FORW, BUNDLE_CNT_NO_FURTHER_INFO, BUNDLE_CNT_RED,
                    BUNDLE_CNT_DEPLETED, BUNDLE_CNT_UNINTEL_EID, BUNDLE_CNT_UNINTEL_BLK, BUNDLE_CNT_RECV_CS,
...
BPLib_AS_Counter_t ResettableSourceCounters[BPLIB_AS_NUM_SRC_CNTRS] = {BUNDLE_CNT_GEN_ACCPT, BUNDLE_CNT_GEN_REJ,
                    ...
                    ADU_CNT_DELVR, ADU_CNT_RECV, BUNDLE_CNT_DEL, BUNDLE_CNT_DEL_EXP, BUNDLE_CNT_DEL_HOP_EXCD,
                    BUNDLE_CNT_DEL_INVAL_PAY, BUNDLE_CNT_DEL_TRAF_PARED, BUNDLE_CNT_DEL_UNINTEL,
                    BUNDLE_CNT_DEL_UNSUPPORT_BLK, BUNDLE_CNT_DISCARDED, BUNDLE_CNT_DEL_NO_STOR, BUNDLE_CNT_DEL_BAD_EID,
                    BUNDLE_CNT_DEL_TOO_LONG, BUNDLE_CNT_CUSTODY_TRANS, BUNDLE_CNT_CUSTODY_REJ, BUNDLE_CNT_CUSTODY_REQ,
                    BUNDLE_CNT_CUSTODY_RE_FORW, BUNDLE_CNT_NO_FURTHER_INFO, BUNDLE_CNT_RED, BUNDLE_CNT_DEPLETED,
                    BUNDLE_CNT_UNINTEL_EID, BUNDLE_CNT_UNINTEL_BLK, BUNDLE_CNT_RECV_CS, BUNDLE_CNT_GEN_CS,
                    BUNDLE_CNT_REJ_CUSTODY};

BPLib_AS_Counter_t BundleCounters[BPLIB_AS_NUM_BNDL_CNTRS] = {BUNDLE_CNT_GEN_ACCPT, BUNDLE_CNT_GEN_REJ,
                    BUNDLE_CNT_GEN_CUSTODY, BUNDLE_CNT_GEN_BSR_RECV, BUNDLE_CNT_GEN_BSR_ACCPT, BUNDLE_CNT_GEN_BSR_FORW,
                    BUNDLE_CNT_GEN_BSR_DELVR, BUNDLE_CNT_GEN_BSR_DEL, BUNDLE_CNT_MAX_BSR_RATE_EXCD,
                    BUNDLE_CNT_RECV_BSR_RECV, BUNDLE_CNT_RECV_BSR_ACCPT, BUNDLE_CNT_RECV_BSR_FORW,
                    BUNDLE_CNT_RECV_BSR_DELVR, BUNDLE_CNT_RECV_BSR_DEL, BUNDLE_CNT_GEN_CRS, BUNDLE_CNT_GEN_CRS_RECV,
                    BUNDLE_CNT_GEN_CRS_ACCPT, BUNDLE_CNT_GEN_CRS_FORW, BUNDLE_CNT_GEN_CRS_DELVR, BUNDLE_CNT_GEN_CRS_DEL,
                    BUNDLE_CNT_MAX_CRS_RATE_EXCD, BUNDLE_CNT_RECV_CRS, BUNDLE_CNT_RECV_CRS_RECV,
                    BUNDLE_CNT_RECV_CRS_ACCPT, BUNDLE_CNT_RECV_CRS_FORW, BUNDLE_CNT_RECV_CRS_DELVR,
                    BUNDLE_CNT_RECV_CRS_DEL, BUNDLE_CNT_GEN_FRAG, BUNDLE_CNT_RECV, BUNDLE_CNT_RECV_FRAG,
                    BUNDLE_CNT_UNPROC_BLKS, BUNDLE_CNT_INVAL_PRI_BLK, BUNDLE_CNT_CS_RECV, BUNDLE_CNT_FORW,
                    BUNDLE_CNT_FORW_FAILED, BUNDLE_CNT_FRAG, BUNDLE_CNT_REASSEMBLED, BUNDLE_CNT_FRAG_ERR,
                    BUNDLE_CNT_DELVR, BUNDLE_CNT_ABAND, ADU_CNT_DELVR, ADU_CNT_RECV, BUNDLE_CNT_DEL, BUNDLE_CNT_DEL_EXP,
                    BUNDLE_CNT_DEL_HOP_EXCD, BUNDLE_CNT_DEL_INVAL_PAY, BUNDLE_CNT_DEL_TRAF_PARED,
                    BUNDLE_CNT_DEL_UNINTEL, BUNDLE_CNT_DEL_UNSUPPORT_BLK, BUNDLE_CNT_DISCARDED, BUNDLE_CNT_DEL_NO_STOR,
                    BUNDLE_CNT_DEL_TOO_LONG, BUNDLE_CNT_CUSTODY_TRANS, BUNDLE_CNT_CUSTODY_REJ, BUNDLE_CNT_CUSTODY_REQ,
                    BUNDLE_CNT_CUSTODY_RE_FORW, BUNDLE_CNT_NO_FURTHER_INFO, BUNDLE_CNT_RED, BUNDLE_CNT_DEPLETED,
                    BUNDLE_CNT_UNINTEL_EID, BUNDLE_CNT_UNINTEL_BLK, BUNDLE_CNT_RECV_CS, BUNDLE_CNT_GEN_CS,
                    BUNDLE_CNT_REJ_CUSTODY};

BPLib_AS_Counter_t ErrorCounters[BPLIB_AS_NUM_ERR_CNTRS] = {BUNDLE_AGT_REJ_CNT, BUNDLE_CNT_GEN_REJ,
                    BUNDLE_CNT_UNPROC_BLKS, BUNDLE_CNT_INVAL_PRI_BLK, BUNDLE_CNT_FRAG_ERR, BUNDLE_CNT_ABAND,
                    BUNDLE_CNT_DEL_INVAL_PAY, BUNDLE_CNT_DEL_UNINTEL, BUNDLE_CNT_DEL_UNSUPPORT_BLK,
                    BUNDLE_CNT_DEL_NO_STOR, BUNDLE_CNT_DEL_BAD_EID, BUNDLE_CNT_DEL_UNAUTH, BUNDLE_CNT_DEL_TOO_LONG,
                    BUNDLE_CNT_CUSTODY_REJ, BUNDLE_CNT_REJ_CUSTODY};

...
typedef struct
{
    ...
    uint32_t BundleCountInCustody;                  /** \brief Number of bundles in custody */
    ...
    uint32_t BundleCountStorageAvailable;           /** \brief Remaining bundle storage available */
    uint32_t BundleCountStored;                     /** \brief Number of bundles stored */
...
typedef struct
{
    ...
    uint32_t BundleCountGeneratedFragment;        /** \brief Number of Bundle Fragments that were Generated */
    uint32_t BundleCountGeneratedRejected;        /** \brief Number of Rejected Bundle Transmission Requests */
    uint32_t BundleCountInCustody;                /** \brief Number of bundles held in custody */
    uint32_t BundleCountInvalidPrimaryBlock;      /** \brief Number of Unprocessed Bundles received with Invalid Primary Blocks */
    uint32_t BundleCountMaxBsrRateExceeded;       /** \brief Number of BSR bundles not sent because sending would exceed a maximum rate. */
    uint32_t BundleCountNoContact;                /** \brief Number of bundles for which rejected Custody Signals generated indicating the Destination is not reachable before the Bundle expires */
    uint32_t BundleCountNoFurtherInfo;            /** \brief Number of bundles for which successful Custody Signals generated with No Further Information */
...
typedef enum
{
    ...
    ADU_CNT_DELVR                = 0 , /** \brief BPLib_AS_NodeCounters.AduCountDelivered                  | BPLib_AS_SourceCounters.SourceCounters[X].AduCountDelivered */
    ADU_CNT_RECV                 = 1 , /** \brief BPLib_AS_NodeCounters.AduCountReceived                   | BPLib_AS_SourceCounters.SourceCounters[X].AduCountReceived */
    BUNDLE_AGT_ACCPT_CNT         = 2 , /** \brief BPLib_AS_NodeCounters.BundleAgentAcceptedDirectiveCount  | BPLib_AS_SourceCounters.SourceCounters[X].BundleAgentAcceptedDirectiveCount */
    BUNDLE_AGT_REJ_CNT           = 3 , /** \brief BPLib_AS_NodeCounters.BundleAgentRejectedDirectiveCount  | BPLib_AS_SourceCounters.SourceCounters[X].BundleAgentRejectedDirectiveCount */
    BUNDLE_CNT_ABAND             = 4 , /** \brief BPLib_AS_NodeCounters.BundleCountAbandoned               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountAbandoned */
    BUNDLE_CNT_CUSTODY_RE_FORW   = 5 , /** \brief BPLib_AS_NodeCounters.BundleCountCustodyReForwarded      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountCustodyReForwarded */
    BUNDLE_CNT_CUSTODY_REJ       = 6 , /** \brief BPLib_AS_NodeCounters.BundleCountCustodyRejected         | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountCustodyRejected */
    BUNDLE_CNT_CUSTODY_REQ       = 7 , /** \brief BPLib_AS_NodeCounters.BundleCountCustodyRequest          | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountCustodyRequest */
    BUNDLE_CNT_CS_RECV           = 8 , /** \brief BPLib_AS_NodeCounters.BundleCountCustodySignalReceived   | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountCustodySignalReceived */
    BUNDLE_CNT_CUSTODY_TRANS     = 9 , /** \brief BPLib_AS_NodeCounters.BundleCountCustodyTransferred      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountCustodyTransferred */
    BUNDLE_CNT_DEL               = 10, /** \brief BPLib_AS_NodeCounters.BundleCountDeleted                 | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeleted */
    BUNDLE_CNT_DEL_BAD_EID       = 11, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedBadEid           | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedBadEid */
    BUNDLE_CNT_DEL_CANCELLED     = 12, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedCancelled        | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedCancelled */
    BUNDLE_CNT_DEL_EXP           = 13, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedExpired          | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedExpired */
    BUNDLE_CNT_DEL_FORW_FAILED   = 14, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedForwardFailed    | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedForwardFailed */
    BUNDLE_CNT_DEL_HOP_EXCD      = 15, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedHopExceeded      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedHopExceeded */
    BUNDLE_CNT_DEL_INVAL_PAY     = 16, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedInvalidPayload   | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedInvalidPayload */
    BUNDLE_CNT_DEL_NO_STOR       = 17, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedNoStorage        | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedNoStorage */
    BUNDLE_CNT_DEL_TRAF_PARED    = 18, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedTrafficPared     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedTrafficPared */
    BUNDLE_CNT_DEL_UNAUTH        = 19, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedUnauthorized     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedUnauthorized */
    BUNDLE_CNT_DEL_UNINTEL       = 20, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedUnintelligible   | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedUnintelligible */
    BUNDLE_CNT_DEL_UNSUPPORT_BLK = 21, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedUnsupportedBlock | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedUnsupportedBlock */
    BUNDLE_CNT_DEL_TOO_LONG      = 22, /** \brief BPLib_AS_NodeCounters.BundleCountDeletedTooLong          | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDeletedTooLong */
    BUNDLE_CNT_DELVR             = 23, /** \brief BPLib_AS_NodeCounters.BundleCountDelivered               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDelivered */
    BUNDLE_CNT_DEPLETED          = 24, /** \brief BPLib_AS_NodeCounters.BundleCountDepleted                | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDepleted */
    BUNDLE_CNT_DISCARDED         = 25, /** \brief BPLib_AS_NodeCounters.BundleCountDiscarded               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountDiscarded */
    BUNDLE_CNT_FORW              = 26, /** \brief BPLib_AS_NodeCounters.BundleCountForwarded               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountForwarded */
    BUNDLE_CNT_FORW_FAILED       = 27, /** \brief BPLib_AS_NodeCounters.BundleCountForwardedFailed         | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountForwardedFailed */
    BUNDLE_CNT_FRAG_ERR          = 28, /** \brief BPLib_AS_NodeCounters.BundleCountFragmentError           | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountFragmentError */
    BUNDLE_CNT_FRAG              = 29, /** \brief BPLib_AS_NodeCounters.BundleCountFragmented              | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountFragmented */
    BUNDLE_CNT_GEN_ACCPT         = 30, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedAccepted       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountGeneratedAccepted */
    BUNDLE_CNT_GEN_ANON          = 31, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedAnonymous      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountGeneratedAnonymous */
    BUNDLE_CNT_GEN_BSR_ACCPT     = 32, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedBsrAccepted */
    BUNDLE_CNT_GEN_BSR_DEL       = 33, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedBsrDeleted */
    BUNDLE_CNT_GEN_BSR_DELVR     = 34, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedBsrDelivered */
    BUNDLE_CNT_GEN_BSR_FORW      = 35, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedBsrForwarded */
    BUNDLE_CNT_GEN_BSR_RECV      = 36, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedBsrReceived */
    BUNDLE_CNT_GEN_CRS           = 37, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrs */
    BUNDLE_CNT_GEN_CRS_ACCPT     = 38, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrsAccepted */
    BUNDLE_CNT_GEN_CRS_DEL       = 39, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrsDeleted */
    BUNDLE_CNT_GEN_CRS_DELVR     = 40, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrsDelivered */
    BUNDLE_CNT_GEN_CRS_FORW      = 41, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrsForwarded */
    BUNDLE_CNT_GEN_CRS_RECV      = 42, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCrsReceived */
    BUNDLE_CNT_GEN_CUSTODY       = 43, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCustody */
    BUNDLE_CNT_GEN_CS            = 44, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedCustodySignal  | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountGeneratedCustodySignal */
    BUNDLE_CNT_GEN_FRAG          = 45, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedFragment       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountGeneratedFragment */
    BUNDLE_CNT_GEN_REJ           = 46, /** \brief BPLib_AS_NodeCounters.BundleCountGeneratedRejected       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountGeneratedRejected */
    BUNDLE_CNT_IN_CUSTODY        = 47, /** \brief BPLib_AS_NodeCounters.BundleCountInCustody               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountInCustody */
    BUNDLE_CNT_INVAL_PRI_BLK     = 48, /** \brief BPLib_AS_NodeCounters.BundleCountInvalidPrimaryBlock     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountInvalidPrimaryBlock */
    BUNDLE_CNT_MAX_BSR_RATE_EXCD = 49, /** \brief BPLib_AS_NodeCounters.BundleCountMaxBsrRateExceeded      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountMaxBsrRateExceeded */
    BUNDLE_CNT_MAX_CRS_RATE_EXCD = 50, /** \brief BPLib_AS_NodeCounters.BundleCountMaxCrsRateExceeded */
    BUNDLE_CNT_NO_CONTACT        = 51, /** \brief BPLib_AS_NodeCounters.BundleCountNoContact               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountNoContact */
    BUNDLE_CNT_NO_FURTHER_INFO   = 52, /** \brief BPLib_AS_NodeCounters.BundleCountNoFurtherInfo           | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountNoFurtherInfo */
    BUNDLE_CNT_NO_ROUTE          = 53, /** \brief BPLib_AS_NodeCounters.BundleCountNoRoute                 | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountNoRoute */
    BUNDLE_CNT_REASSEMBLED       = 54, /** \brief BPLib_AS_NodeCounters.BundleCountReassembled             | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReassembled */
    BUNDLE_CNT_RECV              = 55, /** \brief BPLib_AS_NodeCounters.BundleCountReceived                | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceived */
    BUNDLE_CNT_RECV_ADMIN_REC    = 56, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedAdminRecord     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedAdminRecord */
    BUNDLE_CNT_RECV_BSR_ACCPT    = 57, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedBsrAccepted     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedBsrAccepted */
    BUNDLE_CNT_RECV_BSR_DEL      = 58, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedBsrDeleted      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedBsrDeleted */
    BUNDLE_CNT_RECV_BSR_DELVR    = 59, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedBsrDelivered    | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedBsrDelivered */
    BUNDLE_CNT_RECV_BSR_FORW     = 60, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedBsrForwarded    | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedBsrForwarded */
    BUNDLE_CNT_RECV_BSR_RECV     = 61, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedBsrReceived     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedBsrReceived */
    BUNDLE_CNT_RECV_CRS          = 62, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrs             | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrs */
    BUNDLE_CNT_RECV_CRS_ACCPT    = 63, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrsAccepted     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrsAccepted */
    BUNDLE_CNT_RECV_CRS_DEL      = 64, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrsDeleted      | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrsDeleted */
    BUNDLE_CNT_RECV_CRS_DELVR    = 65, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrsDelivered    | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrsDelivered */
    BUNDLE_CNT_RECV_CRS_FORW     = 66, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrsForwarded    | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrsForwarded */
    BUNDLE_CNT_RECV_CRS_RECV     = 67, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCrsReceived     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCrsReceived */
    BUNDLE_CNT_RECV_CS           = 68, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedCustodySignal   | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedCustodySignal */
    BUNDLE_CNT_RECV_FRAG         = 69, /** \brief BPLib_AS_NodeCounters.BundleCountReceivedFragment        | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReceivedFragment */
    BUNDLE_CNT_RED               = 70, /** \brief BPLib_AS_NodeCounters.BundleCountRedundant               | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountRedundant */
    BUNDLE_CNT_REJ_CUSTODY       = 71, /** \brief BPLib_AS_NodeCounters.BundleCountRejectedCustody         | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountRejectedCustody */
    BUNDLE_CNT_RET               = 72, /** \brief BPLib_AS_NodeCounters.BundleCountReturned                | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountReturned */
    BUNDLE_CNT_STOR_AVAIL        = 73, /** \brief BPLib_AS_NodeCounters.BundleCountStoreageAvailable       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountStoreageAvailable */
    BUNDLE_CNT_STOR              = 74, /** \brief BPLib_AS_NodeCounters.BundleCountStored                  | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountStored */
    BUNDLE_CNT_UNINTEL_BLK       = 75, /** \brief BPLib_AS_NodeCounters.BundleCountUnintelligibleBlock     | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountUnintelligibleBlock */
    BUNDLE_CNT_UNINTEL_EID       = 76, /** \brief BPLib_AS_NodeCounters.BundleCountUnintelligibleEid       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountUnintelligibleEid */
    BUNDLE_CNT_UNPROC_BLKS       = 77, /** \brief BPLib_AS_NodeCounters.BundleCountUnprocessedBlocks       | BPLib_AS_SourceCounters.SourceCounters[X].BundleCountUnprocessedBlocks */
    NODE_STARTUP_CNTR            = 78, /** \brief BPLib_AS_NodeCounters.NodeStartupCounter                 | BPLib_AS_SourceCounters.SourceCounters[X].NodeStartupCounter */
} BPLib_AS_Counter_t;

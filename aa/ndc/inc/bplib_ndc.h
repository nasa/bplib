...
typedef struct BPLib_ChannelHkTlmPayloadSet
{
    ...
    uint8_t     Status;             /**< \brief Configured, Running, or Off */
    uint8_t     RegistrationState;  /**< \brief Active, PassiveDefered or PassiveAbandon */
...
typedef struct BPLib_ContactHkTlmPayloadSet
{
    ...
    uint8_t     Status;                         /**< \brief Configured, Running, or Off */
    char        EIDs[BPLIB_NDC_MAX_EID_STRING]; /**< \brief List of EIDs */
    uint32_t    OutputQueueID;                  /**< \brief Output queue ID */
...
{
    char SystemNodeName[BPLIB_NDC_MAX_NUM_STRING];              /**< \brief Textual name of a DTN Node entity */
    char SystemNodeOwner[BPLIB_NDC_MAX_NUM_STRING];             /**< \brief Textual identifier of the node manager */
    char SystemSoftwareExec[BPLIB_NDC_MAX_NUM_STRING];          /**< \brief Textual identification of the underlying OS or excutive */
    char SystemSoftwareExecVersion[BPLIB_NDC_MAX_NUM_STRING];   /**< \brief Textual representation of the version and patch-level */
    uint32_t BundleAgentNodeNumber;                             /**< \brief Node Number */
    char BundleAgentVersion[BPLIB_NDC_MAX_NUM_STRING];          /**< \brief Version of the executing Node */
    char BundleAgentOperationalState[BPLIB_NDC_MAX_NUM_STRING]; /**< \brief Indication of the Node operational state */
    char BundleAgentConfiguration[BPLIB_NDC_MAX_NUM_STRING];    /**< \brief Indication of the current Node configuration */
...
{
    char SourceEID[BPLIB_NDC_MAX_NUM_STRING];   /**< \brief Source EID to which this telemetry corresponds */
